...
-- Insert data APBDes untuk beberapa tahun
...
(2, 3, 'Bantuan Pendidikan', 75000000.00, 60000000.00, 15000000.00, 'Bantuan untuk 100 siswa kurang mampu', '2025-04-05'),
(2, 4, 'Operasional Kantor Desa', 60000000.00, 55000000.00, 5000000.00, 'Biaya operasional bulanan', '2025-05-01');
...
(3, 'Pelatihan UMKM Desa Minggiran', 'Pelatihan pembuatan produk unggulan dan pemasaran digital untuk 50 pelaku UMKM desa', 'Balai Desa', '2025-03-15', '2025-04-10', 50000000.00, 35000000.00, 15000000.00, 'selesai', 'foto_pelatihan_umkm.jpg');

-- Insert detail penggunaan dana kegiatan
...
(1, 'Alat Berat', 20, 'hari', 25000.00, 500000.00, 'Sewa alat berat'),
(2, 'Semen', 500, 'sak', 70000.00, 35000000.00, 'Semen Portland'),
(2, 'Batu Bata', 20000, 'buah', 1500.00, 30000000.00, 'Batu bata merah'),
(2, 'Besi Beton', 3000, 'batang', 50000.00, 150000000.00, 'Besi beton 8mm dan 10mm'),
(3, 'Bahan Pelatihan', 50, 'paket', 200000.00, 10000000.00, 'Modul dan bahan praktek'),
(3, 'Honor Instruktur', 10, 'sesi', 1500000.00, 15000000.00, 'Instruktur profesional');

-- Insert beberapa contoh forum posts
...
(3, 2, 'Ahmad Fauzi', 'Anak-anak di Dusun Rejowinangun kesulitan mengikuti pembelajaran online karena sinyal internet buruk', 'Kami sedang mengupayakan penguatan sinyal di daerah tersebut dan menyediakan wifi gratis di balai desa untuk pembelajaran.', '2025-02-05 09:45:00');