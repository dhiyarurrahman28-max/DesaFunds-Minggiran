    ...
    <main class="container my-4">
        ...
        <div class="table-container">
            ...
            <div class="mb-3">
                <div class="d-flex justify-content-between mb-1">
                    ...
                    <span><?php echo number_format(($apbdes['total_pengeluaran'] / $apbdes['total_anggaran']) * 100, 1); ?>%</span>
                </div>
                <div class="progress">
                    <div class="progress-bar" role="progressbar" 
                         style="width: <?php echo ($apbdes['total_pengeluaran'] / $apbdes['total_anggaran']) * 100; ?>%"
                         aria-valuenow="<?php echo ($apbdes['total_pengeluaran'] / $apbdes['total_anggaran']) * 100; ?>" 
        ...
        <?php else: ?>
            <div class="table-container text-center">
                <h4 class="text-muted">Data APBDes Tahun <?php echo $selected_year; ?> Belum Tersedia</h4>
