        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="dashboard-section">
                    ...
                    <?php endif; ?>
                    <div class="text-center mt-3">
                        <a href="forum.php" class="btn btn-outline-primary btn-sm">Kelola Forum</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="dashboard-section">
            ...
            <div class="row">
                <div class="col-md-3 mb-2">
                    <a href="forum.php" class="btn btn-primary w-100">
                        Balas Pesan Forum
                    </a>
                </div>
                <div class="col-md-3 mb-2">
                    <a href="admin_apbdes.php" class="btn btn-success w-100">
                        Kelola APBDes
                    </a>
                </div>
                <div class="col-md-3 mb-2">
                    <a href="admin_kegiatan.php" class="btn btn-info w-100">
                        Kelola Kegiatan
                    </a>
                </div>
                <div class="col-md-3 mb-2">
                    <a href="admin_logout.php" class="btn btn-danger w-100">
                        Logout
                    </a>
                </div>
            </div>
