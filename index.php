...
// Ambil data APBDes tahun 2025 dengan error handling
try {
...
// Ambil data pemasukan dan pengeluaran untuk chart dengan error handling
try {
    // Data pemasukan per jenis
    $stmt = $pdo->prepare("
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="mb-4">Platform digital untuk memantau pengelolaan keuangan desa secara transparan dan akuntabel. Warga dapat melihat langsung alokasi dana, realisasi kegiatan, dan memberikan masukan untuk pembangunan desa.</p>
                    <a href="#dashboard" class="btn btn-light btn-lg">Lihat Dashboard</a>
                </div>
                <div class="col-lg-6 text-center">
                    <img src="data:image/svg+xml;base64," alt="Desa Funds Illustration" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
        ...
        const pemasukanChart = new Chart(pemasukanCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: [
                        '#1966f5', '#14b8a6', '#10b981', '#f59e0b', '#ef4444', '#8b5cf6'
                    ]
                }]
            },
            options: {
